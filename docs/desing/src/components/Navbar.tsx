        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
          <nav
            ...
            className={cn(
              ...
              scrolled
                ? "glass-light shadow-[0_18px_50px_-24px_rgba(27,16,22,0.5)]"
      ...
      >
        ...
        >
          ...
          <a
            ...
            rel="noreferrer"
            onClick={() => setOpen(false)}
            className="mt-6 block rounded-full bg-ink-900 py-3.5 text-center text-sm font-semibold text-cream-50"
          >
            Agendar por WhatsApp
          </a>
          <p className="mt-4 text-center text-xs text-ink-600">
            Cra. 6 #62-31, La Castellana · Montería
          </p>
        </div>
      </div>
    </>
