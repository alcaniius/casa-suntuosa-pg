...
import { faqs, WHATSAPP } from "@/data/salon";
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Reveal delay={160}>
            <p className="mt-5 text-[0.98rem] leading-relaxed text-ink-700">
              ¿Tienes alguna duda específica sobre tu tipo de cabello o un tratamiento? Escríbenos por WhatsApp y te orientamos de inmediato.
            </p>
          </Reveal>
          <Reveal delay={230}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group mt-7 inline-flex items-center gap-3 rounded-2xl border border-ink-900/10 bg-white p-4 pr-6 transition-all duration-400 hover:-translate-y-1 hover:border-gold-400/60 hover:shadow-[0_24px_50px_-28px_rgba(27,16,22,0.5)] shadow-sm"
            >
        ...
        <div className="flex flex-col gap-3">
          {faqs.map((f, i) => {
            const isOpen = open === i;
            return (
              <Reveal key={f.q} delay={i * 60} direction="right">
                <div
                  className={cn(
